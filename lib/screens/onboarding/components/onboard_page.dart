...
import 'package:teams_clone/models/onboard_page_model.dart';
                      ...
                      child: IconButton(
                        ...
                        onPressed: () async {
                          if (widget.pageController.page <=
                            ...
                            colorProvider
                                .setColor(widget.pageModel.nextAccentColor);
                          } else {
                            SharedPreferences s =
                                await SharedPreferences.getInstance();
                            s.setBool('is_first_time', false);

                            Utils.navigateTo(context, MainAuthScreen());
                          }
                        },
                      ),
                    ),
