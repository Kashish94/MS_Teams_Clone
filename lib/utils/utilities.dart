...
import 'package:teams_clone/enum/toast_type.dart';
...
class Utils {
  ...
  static Future navigateTo(context, Widget screen) async =>
  ...
  static void showToast(String message, ToastType toastType,
    ...
    Fluttertoast.showToast(
      ...
      fontSize: 16.0,
      backgroundColor:
          toastType != ToastType.SUCCESS ? Colors.red : Colors.green,
